...
/**
 * Created by Eenie on 2017/7/4 at 20:27
 * Email: 472279981@qq.com
 * Des:
 */

public class ReportPostStatisticsSettingActivity extends BaseActivity
    ...
    private void showRequestPermissionDialog() {
        if (this.shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
            Snackbar.make(rootView, "请提供摄像头及文件权限，以拍摄和预览相机图片!", Snackbar.LENGTH_INDEFINITE)
                    .setAction("OK", v -> {
                        PermissionManager.requestCamera(ReportPostStatisticsSettingActivity.this, REQUEST_CAMERA_PERMISSION);
                    }).show();
