...
/**
 * Created by Eenie on 2017/5/24 at 18:15
 * Email: 472279981@qq.com
 * Des:
 */

public class ReportPostEditActivity extends BaseActivity {
    ...
    protected int getContentView() {
        return R.layout.activity_edit_report_post;
    }
    ...
    protected void updateUI() {
        ...
        if (data != null) {
            mId = data.getId();
            mClassId = data.getService().getId();
            mPostId = data.getPostsetting().getId();
            mPostName=data.getPostsetting().getPost();
            mServiceName=data.getService().getServicesname();
            selectPost.setText(data.getPostsetting().getPost());
            selectClass.setText(data.getService().getServicesname());
            selectTimeSpace.setText(data.getJetlag());
            timeSpace = data.getJetlag();
            try {
                JSONArray ts = new JSONArray(data.getReportingtime());
                for (int i = 0; i < ts.length(); i++) {
                    mList.add(ts.getString(i));
    ...
    private void editReportPost() {
        ReportPost reportPost = new ReportPost(mId, timeSpace, mPostId + "", projectId, mClassId + "",
        ...
        class ExchangeWorkViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                if (mDialogs != null) {
                    ...
                    mServiceName = mClassMeetingList.getServicesname();
        ...
        class PostViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                if (mDialog != null) {
                    ...
                    mPostName = mContactList.getPost();
