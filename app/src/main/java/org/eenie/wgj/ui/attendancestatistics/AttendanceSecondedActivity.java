...
import org.eenie.wgj.model.response.AttendanceSecondedResponse;
...
/**
 * Created by Eenie on 2017/6/23 at 10:03
 * Email: 472279981@qq.com
 * Des:
 */

public class AttendanceSecondedActivity extends BaseActivity implements
    ...
    private void getData(String projectId, String date) {
        mSubscription = mRemoteService.getSecondInformation(mPrefsHelper.
                ...
                .subscribe(new Subscriber<ApiResponse>() {
                    ...
                    public void onNext(ApiResponse apiResponse) {
                        ...
                        if (apiResponse.getResultCode() == 200 || apiResponse.getResultCode() == 0) {
                            ...
                            ArrayList<AttendanceSecondedResponse> data = gson.fromJson(jsonArray,
                                    new TypeToken<ArrayList<AttendanceSecondedResponse>>() {
                                    }.getType());
                            if (data != null) {
                                if (mAdapter != null) {
    ...
    class ProjectAdapter extends RecyclerView.Adapter<ProjectAdapter.ProjectViewHolder> {
        ...
        private ArrayList<AttendanceSecondedResponse> projectMonth;

        public ProjectAdapter(Context context, ArrayList<AttendanceSecondedResponse> projectMonth) {
        ...
        public void onBindViewHolder(ProjectViewHolder holder, int position) {
            if (projectMonth != null && !projectMonth.isEmpty()) {
                AttendanceSecondedResponse data = projectMonth.get(position);
                if (data != null) {

                        holder.itemTitle.setText("借调人员  " + data.getUser());

                    holder.itemDate.setText("借调班次  " + data.getService());
                    holder.itemCause.setText("借调时间  " + data.getCreated_at());
        ...
        public void addAll(ArrayList<AttendanceSecondedResponse> projectMonth) {
