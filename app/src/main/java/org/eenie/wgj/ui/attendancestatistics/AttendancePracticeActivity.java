...
import org.eenie.wgj.model.response.AttendancePracticeResponse;
...
/**
 * Created by Eenie on 2017/6/23 at 10:13
 * Email: 472279981@qq.com
 * Des:
 * 实习
 */

public class AttendancePracticeActivity  extends BaseActivity implements
    ...
    private void getData(String projectId, String date) {
        mSubscription = mRemoteService.getPracticeInformation(mPrefsHelper.
                ...
                .subscribe(new Subscriber<ApiResponse>() {
                    ...
                    public void onNext(ApiResponse apiResponse) {
                        ...
                        if (apiResponse.getResultCode() == 200 || apiResponse.getResultCode() == 0) {
                            ...
                            ArrayList<AttendancePracticeResponse> data = gson.fromJson(jsonArray,
                                    new TypeToken<ArrayList<AttendancePracticeResponse>>() {
                                    }.getType());
                            if (data != null) {
                                if (mAdapter != null) {
    ...
    class ProjectAdapter extends RecyclerView.Adapter<ProjectAdapter.ProjectViewHolder> {
        ...
        private ArrayList<AttendancePracticeResponse> projectMonth;

        public ProjectAdapter(Context context, ArrayList<AttendancePracticeResponse> projectMonth) {
        ...
        public void onBindViewHolder(ProjectViewHolder holder, int position) {
            if (projectMonth != null && !projectMonth.isEmpty()) {
                AttendancePracticeResponse data = projectMonth.get(position);
                if (data != null) {

                    holder.itemTitle.setText("实习人员  " + data.getUser());

                    holder.itemDate.setText("实习班次  " + data.getService());
                    holder.itemCause.setText("实习时间  " + data.getCreated_at());
        ...
        public void addAll(ArrayList<AttendancePracticeResponse> projectMonth) {
