...
import org.eenie.wgj.ui.mytest.PictureFragment;
...
/**
 * Created by Eenie on 2017/6/18 at 14:02
...
public class TakePhotoActivity extends BaseActivity implements
    ...
    private Button mTakeBT, mThreeFourBT, mFourThreeBT,
            mNineSixteenBT, mSixteenNineBT, mFitImgBT, mCircleBT, mFreeBT, mSquareBT,
    ...
    protected int getContentView() {
        return R.layout.activity_take_photo_sign;
    }
...
//                            bundle.putParcelable(ORIGIN_PICTURE, originBitmap);
    ...
    public void onTakePhoto(Bitmap bitmap) {
        ...
        if (!TextUtils.isEmpty(path)) {
            setResult(TakePhotoActivity.RESULT_CODE, getIntent().putExtra("path", path));
            finish();
        } else {
    ...
    public String savePic(Bitmap bm) {
        String path = getExternalCacheDir().getAbsolutePath() +
                "/sign_" + System.currentTimeMillis() + "_attendance.png";
