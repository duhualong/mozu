...
public class RountingWorkActivity extends BaseActivity {
    ...
    private void showTimeEndDialog() {
        ...
        btnOk.setOnClickListener(v -> {
            ...
            if (!TextUtils.isEmpty(hour)&&!TextUtils.isEmpty(minute)) {
                ...
                Toast.makeText(context,"请设置巡检结束的时间",Toast.LENGTH_LONG).show();
            }
    ...
    private void showTimeStartDialog() {
        ...
        btnOk.setOnClickListener(v -> {
            ...
            if (!TextUtils.isEmpty(hour)&&!TextUtils.isEmpty(minute)) {
                ...
                Toast.makeText(context,"请设置巡检开始的时间",Toast.LENGTH_LONG).show();
            }
