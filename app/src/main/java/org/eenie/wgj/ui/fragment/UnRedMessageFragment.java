...
/**
 * Created by Eenie on 2017/7/21 at 17:52
 * Email: 472279981@qq.com
 * Des:
 */

public class UnRedMessageFragment extends BaseSupportFragment {
    ...
    private void getData(int currentPage) {
        if (currentPage <= totalPager) {
            ...
            mSubscription = mRemoteService.queryNewMessageNotice(mPrefsHelper.
                            getPrefs().getString(Constants.TOKEN, ""), currentPage,
                    0)
                                ...
                                if (data.getData() != null) {
                                    ...
                                    adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
                                        ...
                                        public void onItemClick(View view, int position) {
                                            ...
                                            if (dataBean.get(position).getKey() == 2201||dataBean.get(position).getKey()==1101) {
...
//        adapter.notifyDataSetChanged();
        ...
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (dataBean.get(position).getKey() == 1001 || dataBean.get(position).getKey() == 2201) {
                    Intent intent = new Intent(context, ApplyFeedBackActivity.class);
                    intent.putExtra(ApplyFeedBackActivity.APPLY_INFO, dataBean.get(position));
                    startActivity(intent);
                } else {
