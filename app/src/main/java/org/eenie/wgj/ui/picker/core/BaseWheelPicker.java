package org.eenie.wgj.ui.picker.core;
...
public abstract class BaseWheelPicker extends View implements IWheelPicker {
  ...
  protected static class Default {
    ...
    protected static final int WHEEL_TEXT_DATA = R.array.SimpleChineseProvince;
  ...
  public interface OnWheelChangeListener {
    ...
    void onWheelDataSetChanged(BaseWheelPicker wheelPicker, List<String> dataSet);
  }
  ...
  public static class SimpleWheelChangeListener implements OnWheelChangeListener {
    ...
    @Override
    public void onWheelSelected(BaseWheelPicker wheelPicker, int index, String data) {

    }

    @Override
    public void onWheelDataSetChanged(BaseWheelPicker wheelPicker, List<String> dataSet) {
  ...
  protected void onWheelDataSetChanged(BaseWheelPicker wheelPicker, List<String> dataSet) {
    if (mListener != null) {
      mListener.onWheelDataSetChanged(wheelPicker, dataSet);
    }
  }
  ...
  public void setData(List<String> data) {
    ...
    computeWheelSizes();
    requestLayout();
    onWheelDataSetChanged(this, data);
  }
  ...
  @Override
  public void setWheelDecor(boolean ignorePadding, BaseWheelDecor decor) {
