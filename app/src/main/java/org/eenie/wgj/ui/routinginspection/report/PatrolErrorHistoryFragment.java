...
/**
 * Created by Eenie on 2017/6/23 at 15:06
 * Email: 472279981@qq.com
 * Des:
 */

public class PatrolErrorHistoryFragment  extends BaseSupportFragment {
    @BindView(R.id.rv_patrol_error)RecyclerView mRvPatrolError;
    ...
    private void initData() {
        mSubscription=mRemoteService.getReportRoutingList
                (mPrefsHelper.getPrefs().getString(Constants.TOKEN,""),2)
