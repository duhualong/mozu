...
@TargetApi(Build.VERSION_CODES.GINGERBREAD) class OverScrollerCompat implements WheelScroller {
  ...
  OverScrollerCompat(Context context, Interpolator interpolator, float bounceCoefficientX,
                     float bounceCoefficientY) {
    mOverScroller = new OverScroller(context, interpolator, bounceCoefficientX, bounceCoefficientY);
  }

  @TargetApi(Build.VERSION_CODES.HONEYCOMB) OverScrollerCompat(Context context,
                                                               Interpolator interpolator, float bounceCoefficientX, float bounceCoefficientY,
                                                               boolean flywheel) {
    mOverScroller =
        new OverScroller(context, interpolator, bounceCoefficientX, bounceCoefficientY, flywheel);
  }
