...
import org.eenie.wgj.ui.picker.core.BaseWheelDecor;
import org.eenie.wgj.ui.picker.core.BaseWheelPicker;

import java.util.List;

/**
 * @author Zac 2015-12-13
 */
public abstract class WheelCrossPicker extends BaseWheelPicker
  ...
  protected void onSizeChanged(int w, int h, int oldW, int oldH) {
    ...
    if (!ignorePadding) {
      mOrientation.removePadding(rectCurDecor, getPaddingLeft(), getPaddingTop(), getPaddingRight(),
          getPaddingBottom());
    }
  }
  ...
  private void confirmData() {
    ...
    int curIndex = startIndex - unitDeltaTotal / unit;
    ...
    if (!this.curData.equals(curData)) {
      ...
      onWheelSelected(this, curIndex, curData);
    }
  }
  ...
  public void setSelectTextColor(int color) {
    super.setSelectTextColor(color);
