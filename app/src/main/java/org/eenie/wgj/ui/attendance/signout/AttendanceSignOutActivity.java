...
import static org.eenie.wgj.ui.attendance.sign.AttendanceTokePhotoActivity.REQUEST_CODE_NEED_EXTRA;
import static org.eenie.wgj.ui.attendance.sign.AttendanceTokePhotoActivity.RESULT_CODE;

/**
 * Created by Eenie on 2017/6/19 at 11:41
 * Email: 472279981@qq.com
 * Des:
 */

public class AttendanceSignOutActivity extends BaseActivity implements LocationSource,
    ...
    private void signIn(RequestBody requestBody) {
        ...
        Call<ApiResponse> call = fileUploadService.
                signOutAttendance(mPrefsHelper.getPrefs().getString(Constants.TOKEN, ""), requestBody);
    ...
    private void initPopRank(String name) {
