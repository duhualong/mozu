...
/**
 * Created by Eenie on 2017/5/2 at 16:40
 * Email: 472279981@qq.com
 * Des
 */

public class ReportWorkActivity extends BaseActivity {
    @BindView(R.id.tv_set_start_time)TextView startTime;
    @BindView(R.id.tv_set_end_time)TextView endTime;
    ...
    protected void updateUI() {
        ...
        tvStartReportTime.setText("报岗提醒时间");

        getReportAlertData();
    }

    private void getReportAlertData() {
        mSubscription=mRemoteService.getReportAlert(mPrefsHelper.getPrefs().getString(Constants.TOKEN,""))
