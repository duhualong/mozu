...
public class MeetingEndFragment extends BaseSupportFragment {
    ...
    private void initData() {
        mAdapter.clear();
        mSubscription=mRemoteService.getEndMeetingList(mPrefsHelper.getPrefs().getString(Constants.TOKEN,""))
    ...
    class NormalRoutingAdapter extends RecyclerView.Adapter<NormalRoutingAdapter.ProjectViewHolder> {
        ...
        class ProjectViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.rl_detail:
                        startActivity(new Intent(context,MeetingEndDetailActivity.class)
                        .putExtra(MeetingEndDetailActivity.APPLY_ID,String.valueOf(mStartMeeting.getId())));
